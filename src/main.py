...
from src.utils import get_save_path,set_logger
set_logger()
...
def main(cfg: DictConfig):
    ...
    base_cfg = OmegaConf.to_container(cfg.experiment, resolve=False)
    base_cfg = {"_target_": base_cfg.get("_target_")}
    trainer = hydra.utils.instantiate(base_cfg, cfg)
